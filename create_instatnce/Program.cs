...
namespace create_instatnce
{
    class Program
    {
        ...
        {
            //Create an Amazon EC2 client to manage your EC2 resources
            ...
            //add a rule to a security group 
              //first : Create and initialize an IpPermission object.
            ...
            //Create and initialize a network interface to launch an EC2 instance in a VPC
            ...
            //Create and initialize a RunInstancesRequest object
            ...
            var launchRequest = new RunInstancesRequest()
            {
                ...
                //from here you can put the number of instances that you want to launch in one run for this automation script 
                MinCount = 1,
                MaxCount = 3,
                KeyName = keyPairName,
